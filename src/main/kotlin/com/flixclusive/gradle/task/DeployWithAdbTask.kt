...
import com.boooplay.gradle.util.buildValidFilename
...
internal abstract class DeployWithAdbTask : DefaultTask() {
    ...
    fun deployWithAdb() {
        ...
        val activityPath = if (debugApp) {
            "com.boooplay.debug/com.boooplay.mobile.MobileActivity"
        } else "com.boooplay/com.boooplay.mobile.MobileActivity"
    ...
    companion object {
        private const val OLD_DEBUG_LOCAL_FILE_PATH = "/sdcard/Android/data/com.boooplay.debug/files/providers/"
        private const val OLD_LOCAL_FILE_PATH = "/sdcard/Android/data/com.boooplay/files/providers/"

        private const val DEBUG_LOCAL_FILE_PATH = "/storage/emulated/0/Android/data/com.boooplay.debug/files/providers/"
        private const val LOCAL_FILE_PATH = "/storage/emulated/0/Android/data/com.boooplay/files/providers/"
    }
}